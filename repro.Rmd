---
title: "ISLE 6 workshop: Data Management, Version Control, and Reproducibility"
...
This document introduces basic data management techniques, version control measures, and issues relating to reproducible research. The entire R markdown document for this tutorial can be downloaded [here](https://slcladal.github.io/repro.html). [A more detailed introduction to data management, version control, and reproducible research practices](https://slcladal.github.io/repro.html) can be found on the website of the *[Language Technology and Data Analysis Laboratory (LADAL)](https://slcladal.github.io/index.html)*. 
...
Some of the contents of this tutorial build on Amanda Miotto's [Reproducible Reseach Things](https://github.com/amandamiotto/Reproducible-Research-Things). 
...
Schweinberger, Martin. `r format(Sys.time(), '%Y')`. *ISLE 6 workshop: Data Management, Version Control, and Reproducibility*. Brisbane: The University of Queensland. url: https://slcladal.github.io/repro.html (Version `r format(Sys.time(), '%Y.%m.%d')`).
